...
#     "Na última coluna da base, 'Fare', temos a informação da tarifa paga pelo passageiro. A maioria das crianças pagou menos de 25 libras na passagem."
#     )
...
Fare = col1.number_input(label="Valor em libra, da tarifa paga. Ex.: 30.50", value=default_values["Fare"])
